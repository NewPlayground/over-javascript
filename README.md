...
```txt
《JavaScript 编程精解(第 3 版)：佳作《Eloquent JavaScript》，整体偏基础，但是部分内容不适合基础学习，且翻译上并不十分优秀
《JavaScript 权威指南》第 6 版：犀牛书，JS 的百科全书，过于庞大，适合作为工具书。
《JavaScript 语言精粹》修订版：蝴蝶书，是 JS 核心语法的荟萃，短小精悍。
《Head First JavaScript程序设计》：适合完全零基础者学习
```
